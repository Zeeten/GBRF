...
public class PartOneBestChapterSecondListCtl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			dtoList = model.searchChapterSecond(bean, pageNo, pageSize);
			...
			RequestDispatcher rd = request
					.getRequestDispatcher("PartOneBestChapterSecondList.jsp");
