...
public class PartOneBestChapterThirdListCtl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			dtoList = model.searchChapterThird(bean, pageNo, pageSize);
			...
			RequestDispatcher rd = request
					.getRequestDispatcher("PartOneBestChapterThirdList.jsp");
