...
public class KIPJDBCDataSource {
 
    private static KIPJDBCDataSource datasource;
 
    private KIPJDBCDataSource() {
    }
 
    private ComboPooledDataSource cpds = null;
 
    public static KIPJDBCDataSource getInstance() {
        if (datasource == null) {
 
            ResourceBundle rb = ResourceBundle
                    .getBundle("com.ncs.bundle.system");
 
            datasource = new KIPJDBCDataSource();
