...
public class AwardDetailActivity extends ActionBarActivity implements
LoaderCallbacks<Cursor> {
	...
	private void initialisePaging() {
		...
		// AwardDetailFragment.class.getName()));
		fragments.add(Fragment.instantiate(this,
				Timer_Invitation.class.getName()));
	...
	public class UserLogoutTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				...
				edit.commit();
				Intent homeIntent = new Intent(AwardDetailActivity.this,
						LoginActivity.class);
