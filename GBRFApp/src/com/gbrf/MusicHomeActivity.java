...
@SuppressLint("NewApi") 
public class MusicHomeActivity  extends ActionBarActivity implements
LoaderCallbacks<Cursor> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_music_home);
		  ActionBar actionBar = getSupportActionBar();
	        ...
	        RelativeLayout music = (RelativeLayout) findViewById(R.id.relative_layout_music1);
			RelativeLayout idharbhi = (RelativeLayout) findViewById(R.id.relative_layout_music2);
			RelativeLayout bazmmusic = (RelativeLayout) findViewById(R.id.relative_layout_music3);
			...
			idharbhi.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					Intent intent = new Intent(MusicHomeActivity.this,
							IdharBhiMusicActivity.class);
					startActivity(intent);
				}
			});
			bazmmusic.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					Intent intent = new Intent(MusicHomeActivity.this,
							BaharGhazalActivity.class);
					startActivity(intent);
				}
			});
	...
	private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(
				MusicHomeActivity.this, android.R.layout.simple_dropdown_item_1line,
	...
	public class UserLogoutTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
                ...
                edit.commit();
				Intent homeIntent = new Intent(MusicHomeActivity.this,
						LoginActivity.class);
